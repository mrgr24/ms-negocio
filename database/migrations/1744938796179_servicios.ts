...
export default class extends BaseSchema {
  ...
  public async up () {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('idCuota').notNullable().unsigned().references('id').inTable('cuotas').onDelete('CASCADE'),
      table.integer('idEvidencia').notNullable().unsigned().references('id').inTable('evidencias').onDelete('CASCADE'),
      /**
